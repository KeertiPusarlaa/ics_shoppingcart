...
---
### **Steps to setup ics_shopping_cart**
- pip install pyyaml
- pip install neo4j
...
### **Start all the milvus containers at once**
 -docker start milvus-etcd milvus-minio milvus-standalone
 
### **Running the application**
- python neo4j_graph_construction.py
- python neo4j_graph.uplift.py
 
### **Setup vector embeddings**
- python llm_cypher_generator.py "test" --setup --no-execute
 
### **Use**
- python llm_cypher_generator.py "Your natural language question here"